...
describe('Logger', () => {
    let loggerFactory: LoggerFactory = new LoggerFactory();
    ...
    beforeEach(() => {
        ...
        loggerFactory.addLogger({ name: 'none', level: LogLevel.None });
        loggerFactory.addLogger({ name: 'trace', level: LogLevel.Trace });
        loggerFactory.addLogger({ name: 'debug', level: LogLevel.Debug });
        loggerFactory.addLogger({ name: 'info', level: LogLevel.Info });
        loggerFactory.addLogger({ name: 'warn', level: LogLevel.Warn });
        loggerFactory.addLogger({ name: 'error', level: LogLevel.Error });
        
        noneLogger = loggerFactory.getLogger('none');
        traceLogger = loggerFactory.getLogger('trace');
        debugLogger = loggerFactory.getLogger('debug');
        infoLogger = loggerFactory.getLogger('info');
        warnLogger = loggerFactory.getLogger('warn');
    ...
    it('can add appender', () => {
      const addedAppender = new IndexedDBAppender("LoggerSpecTest");
